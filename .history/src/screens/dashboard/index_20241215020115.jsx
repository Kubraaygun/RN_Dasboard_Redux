...
const Dashboard = () => {
  ...
  const calculateTaskStats = status => {
    ...
    const percentage = ((taskCount / 100) * 100).toFixed(2);
    console.log(status, totalTask);
    return percentage;
  };
  return (
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
          <VictoryPie
            ...
            data={[
              ...
              {x: 'In Progress', y: calculateTaskStats(statusTypes.INPROGRESS)},
              {x: 'Complated', y: calculateTaskStats(statusTypes.INREVIEW)},
